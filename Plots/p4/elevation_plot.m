...
sv = x_p4_no_feedback.signals.values(:,5);
rv = x_star_p4_no_feedback.signals.values(:,5);
...
legend('Elevation', 'Optimal path', 'location', 'northeast') % Up rigth corner legends
...
print -depsc2 p10p4_elevation_no_feedback.eps %Sets the filename for export
%close;
